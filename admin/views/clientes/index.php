										...
										<tr>
											<td>
												...
												<?php if ($this->user->hasPermission('cliente_view') && $this->user->hasPermission('cliente_edit')) : ?>
													...
													<?php endif; ?>
												<?php endif; ?>
												<?php if ($this->user->hasPermission('cliente_view') && $this->user->hasPermission('cliente_delet')) : ?>
												<a type="button" data-toggle="tooltip" title="" data-original-title="Deletar" class="btn btn-danger" href="<?php echo BASE_URL ?>clientes/delete/<?php echo $inf['id'] ?>"><i class="fa fa-fw fa-trash"></i></a>
												<?php endif; ?>
											</td>
