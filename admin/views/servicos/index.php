											...
											<?php foreach ($tableDados as $inf) : ?>
												<tr>
													<td>
														...
														<?php endif; ?>
														<a type="button" class="btn btn-danger" href="<?php echo BASE_URL ?>servicos/delete/<?php echo $inf['id'] ?>"><i class="fa fa-fw fa-trash"></i></a>
				...
				<ul class="pagination pagination-sm pull-right">
					<?php for ($q = 1; $q <= $p_count; $q++) : ?>
						<li class="<?php echo ($q == $p) ? 'active' : '' ?> ">
							<a href="<?php echo BASE_URL; ?>servicos?p=<?php $w = $_GET; $w['p'] = $q; echo http_build_query($w);?>"><?php echo $q; ?></a>
						</li>
					<?php endfor; ?>
				</ul>
			</div>
