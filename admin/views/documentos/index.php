												...
												<tr>
													<td>
														...
														<?php if ($this->user->hasPermission('documento_delete')) : ?>
															<a type="button" data-toggle="tooltip" title="" data-original-title="deletar" class="btn btn-danger" href="<?php echo BASE_URL ?>documentos/delete/<?php echo $inf['id'] ?>"><i class="fa fa-fw fa-trash"></i></a>
														<?php endif; ?>
													</td>
