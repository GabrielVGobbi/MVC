...
<div class="col-xs-12">
	<div class="box box-primary">
		...
		<div class="box-body no-padding">
			<?php include_once("filtro.php"); $atraso = 'success';?>
			...
			<a data-toggle="modal" data-target="#modalVisualizar<?php echo $obr[0]; ?>" style="color: #000;    cursor: pointer; ">
				<div class="col-md-4" style="margin-top:20px;">
					<div class="box box-<?php echo $atraso; ?>" style="    border-left: 1px solid;border-right: 1px solid;border-bottom: 1px solid;">
								...
								<div class="row">
									...
									<div class="col-sm-3">
										<div class="description-block">
											...
											<span class="description-text"><?php echo $etapas = count($this->obra->getEtapas($obr[0])); ?></span>
										</div>
									</div>
								</div>
